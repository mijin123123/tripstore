      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative h-80 rounded-xl mb-12 overflow-hidden">
          ...
          <div 
            ...
            style={{
              backgroundImage: `url('https://images.unsplash.com/photo-1566073771259-6a8506099945?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=3840&q=95'), linear-gradient(135deg, #581c87 0%, #7c3aed 50%, #eab308 100%)`
            }}
          ></div>
