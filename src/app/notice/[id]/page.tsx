  ...
  if (!notice) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center">
        ...
        <Link href="/notice" className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-colors">
          공지사항 목록으로 돌아가기
        </Link>
      </div>
    );
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-8">
          ...
          <div className="p-6 border-b">
            ...
            <div className="flex items-center space-x-3 mt-4">
              <button className="inline-flex items-center text-sm text-gray-500 hover:text-blue-600">
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="p-6 border-b">
            <div className="flex items-center">
              ...
              <h2 className="text-xl font-bold text-gray-800">관련 공지사항</h2>
            </div>
          </div>

          <ul className="divide-y divide-gray-100">
            {relatedNotices.map((relatedNotice) => (
              <li key={relatedNotice.id}>
                <Link 
                  ...
                  <div className="p-4 sm:p-6">
                    <div className="flex items-center mb-2">
                      <span className={`
                        ...
                        ${relatedNotice.category === '이벤트' ? 'bg-purple-100 text-purple-800' : ''}
                        ${relatedNotice.category === '공지' ? 'bg-blue-100 text-blue-800' : ''}
                        ${relatedNotice.category === '안내' ? 'bg-green-100 text-green-800' : ''}
                        ${relatedNotice.category === '점검' ? 'bg-orange-100 text-orange-800' : ''}
                        ${relatedNotice.category === '상품' ? 'bg-teal-100 text-teal-800' : ''}
                      `}>
