    ...
    async function fetchData() {
      try {
        ...
        const americasPackages = allPackages.filter(pkg => 
          ...
          (pkg.region === 'americas' || pkg.regionKo === '미주/캐나다/하와이')
        );
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-600 text-lg mb-2">미주 여행 패키지가 준비 중입니다.</p>
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <div className="flex items-center gap-1 text-gray-600 mb-3">
                      <MapPin className="w-4 h-4 flex-shrink-0" />
                      <span className="text-sm truncate">{pkg.regionKo || pkg.region || '미주'}</span>
                    </div>
