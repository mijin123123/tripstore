...
import { MapPin, Calendar, Users, Star, Clock, Plane, Mountain, Camera, ChevronLeft, ChevronRight } from 'lucide-react'
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="mt-12 bg-white rounded-xl shadow-md p-8">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2 line-clamp-2 line-clamp-2">여행 기본 정보</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2 line-clamp-2 line-clamp-2">추천 여행 시기</h3>
                <ul className="space-y-2 text-gray-600">
