...
import { MapPin, Star, Calendar, Waves, Palmtree, Utensils, ChevronLeft, ChevronRight, Search } from 'lucide-react'
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        setFilteredPackages(resortData);
