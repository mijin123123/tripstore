      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative h-80 rounded-xl mb-12 overflow-hidden">
          ...
          <div 
            ...
            style={{
              backgroundImage: `url('https://images.unsplash.com/photo-1578662996442-48f60103fc96?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=7680&q=100&dpr=2'), linear-gradient(135deg, #14532d 0%, #166534 50%, #059669 100%)`
            }}
          ></div>
