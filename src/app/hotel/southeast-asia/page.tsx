...
import { MapPin, Star, Calendar, Wifi, Car, Coffee } from 'lucide-react'
      ...
      <section className="relative h-96 bg-gradient-to-r from-green-600 to-blue-700">
        ...
        <div className="relative max-w-6xl mx-auto px-4 h-full flex items-center">
          <div className="text-white">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">동남아 호텔</h1>
            <p className="text-xl mb-6">열대의 낙원에서 완벽한 휴양을 경험하세요</p>
