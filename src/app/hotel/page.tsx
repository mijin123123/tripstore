      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative h-80 rounded-xl mb-12 overflow-hidden">
          ...
          <div 
            ...
            style={{
              backgroundImage: `url('https://images.unsplash.com/photo-1582719508461-905c673771fd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=7680&q=100&dpr=2'), linear-gradient(135deg, #065f46 0%, #047857 50%, #0d9488 100%)`
            }}
          ></div>
