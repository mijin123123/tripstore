...
export const hardcodedPackages = [
  ...
  },
  {
    ...
    type: "해외여행",
    title: "바르셀로나 문화 탐방 5박 6일",
    description: "가우디의 건축물부터 스페인 음식까지 완벽한 문화 체험",
    price: 1790000,
    duration: "6일",
    image: "https://images.unsplash.com/photo-1583422409516-2895a77efded?q=80&w=1740",
    rating: 4.7,
    reviews: 183,
    name: "바르셀로나 문화 탐방 5박 6일"
  },
  {
    id: "pkg-008",
    destination: "영국 런던",
    type: "해외여행",
    title: "런던 시티 투어 5박 6일",
    description: "빅벤, 런던아이, 버킹엄 궁전을 포함한 완벽한 런던 여행",
    price: 1950000,
    duration: "6일",
    image: "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?q=80&w=1740",
    rating: 4.6,
    reviews: 152,
    name: "런던 시티 투어 5박 6일"
  },
  {
    ...
    destination: "호주 시드니",
    type: "해외여행",
    title: "시드니 완벽 여행 6박 7일",
    description: "오페라 하우스, 본다이 비치를 포함한 시드니 핵심 관광",
    price: 2290000,
    duration: "7일",
    image: "https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?q=80&w=1740",
    rating: 4.8,
    reviews: 136,
    name: "시드니 완벽 여행 6박 7일"
  },
  {
    id: "pkg-010",
    destination: "대한민국 서울",
    type: "국내여행",
    title: "서울 도심 여행 2박 3일",
    description: "경복궁, 명동, 남산타워까지 서울의 핵심을 둘러보는 여행",
    price: 280000,
    duration: "3일",
    image: "https://images.unsplash.com/photo-1538669715315-525d19212bc0?q=80&w=1740",
    rating: 4.5,
    reviews: 112,
    name: "서울 도심 여행 2박 3일"
  }
...
export default hardcodedPackages;
